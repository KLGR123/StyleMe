...
const LipstickChangeColor = new DynamicStructuredTool({
    ...
    schema: z.object({
        color: z
            .string()
            .describe(
                "Set lips color in R G B A format (separated with space). Each value should be in a range from 0 to 1 (including decimal)."
            ),
    }),
    func: async ({ color }) => {
        console.log("LipstickChangeColor with parameter called", color);
        broadcastMessage(
            JSON.stringify({ tool_name: "LipstickChangeColor", params: { color } })
        );
    },
});
...
const LipstickChangeBrightness = new DynamicStructuredTool({
    ...
    schema: z.object({
        brightness: z
            .string()
            .describe(
                "Change lips brightness intensity, where n - any value from 0 to 2 (including decimal). 0 stands for the minimal brightness (black color), 1 stands for standard brightness. Values > 2 may be also provided."
            ),
    }),
    func: async ({ brightness }) => {
        ...
        broadcastMessage(
            JSON.stringify({
                tool_name: "LipstickChangeBrightness",
                params: { brightness },
            })
        );
    },
...
const LipstickChangeSaturation = new DynamicStructuredTool({
    ...
    schema: z.object({
        saturation: z
            .string()
            .describe(
                "changes shine saturation intensity, where n - any value from 0 to 1 (including decimal)."
            ),
    }),
    func: async ({ saturation }) => {
        ...
        broadcastMessage(
            JSON.stringify({
                tool_name: "LipstickChangeSaturation",
                params: { saturation },
            })
        );
    },
...
const LipstickChangeShineIntensity = new DynamicStructuredTool({
    ...
    schema: z.object({
        shineIntensity: z
            .string()
            .describe(
                "changes shine intensity, where n - any value from 0 to 2 (including decimal). Values > 2 may be also provided."
            ),
    }),
    func: async ({ shineIntensity }) => {
        console.log(
            "LipstickChangeShineIntensity with parameter called",
            shineIntensity
        );
        broadcastMessage(
            JSON.stringify({
                tool_name: "LipstickChangeShineIntensity",
                params: { shineIntensity },
            })
        );
    },
});
...
const LipstickChangeShineBleeding = new DynamicStructuredTool({
    ...
    schema: z.object({
        shineBleeding: z
            .string()
            .describe(
                "changes shine blending strength, where n - any value from 0 to 1 (including decimal). Values > 1 may be also provided."
            ),
    }),
    func: async ({ shineBleeding }) => {
        console.log(
            "LipstickChangeShineBleeding with parameter called",
            shineBleeding
        );
        broadcastMessage(
            JSON.stringify({
                tool_name: "LipstickChangeShineBleeding",
                params: { shineBleeding },
            })
        );
    },
});
...
const LipstickChangeShineScale = new DynamicStructuredTool({
    ...
    schema: z.object({
        shineScale: z
            .string()
            .describe(
                "changes shine scale, where n - any value from 0 to 1 (including decimal). 0 stands for the minimal scale (shine disabled), 1 stands for standard scale. Values > 1 may be also provided."
            ),
    }),
    func: async ({ shineScale }) => {
        ...
        broadcastMessage(
            JSON.stringify({
                tool_name: "LipstickChangeShineScale",
                params: { shineScale },
            })
        );
    },
...
const LipstickChangeGlitterGrain = new DynamicStructuredTool({
    ...
    schema: z.object({
        glitterGrain: z
            .string()
            .describe(
                "changes glitter grain strength, where n - any value from 0 to 2 (including decimal). Values > 2 may be also provided."
            ),
    }),
    func: async ({ glitterGrain }) => {
        console.log(
            "LipstickChangeGlitterGrain with parameter called",
            glitterGrain
        );
        broadcastMessage(
            JSON.stringify({
                tool_name: "LipstickChangeGlitterGrain",
                params: { glitterGrain },
            })
        );
    },
...
const LipstickChangeGlitterIntensity = new DynamicStructuredTool({
    ...
    schema: z.object({
        glitterIntensity: z
            .string()
            .describe(
                "changes glitter intensity, where n - any value from 0 to 2 (including decimal). Values > 2 may be also provided."
            ),
    }),
    func: async ({ glitterIntensity }) => {
        console.log(
            "LipstickChangeGlitterIntensity with parameter called",
            glitterIntensity
        );
        broadcastMessage(
            JSON.stringify({
                tool_name: "LipstickChangeGlitterIntensity",
...
const LipstickChangeGlitterBleeding = new DynamicStructuredTool({
    ...
    schema: z.object({
        glitterBleeding: z
            .string()
            .describe(
                "changes glitter blending strength, where n - any value from 0 to 2 (including decimal). Values > 2 may be also provided."
            ),
    }),
    func: async ({ glitterBleeding }) => {
        console.log(
            "LipstickChangeGlitterBleeding with parameter called",
            glitterBleeding
        );
        broadcastMessage(
            JSON.stringify({
                tool_name: "LipstickChangeGlitterBleeding",
                params: { glitterBleeding },
            })
        );
    },
});
...
const BrowChangeColor = new DynamicStructuredTool({
    ...
    schema: z.object({
        color: z
            .string()
            .describe(
                "set brows color in R G B A format (separated with space). Each value should be in a range from 0 to 1 (including decimal)."
            ),
    }),
    func: async ({ color }) => {
        console.log("BrowChangeColor with parameter called", color);
        broadcastMessage(
            JSON.stringify({ tool_name: "BrowChangeColor", params: { color } })
        );
    },
});
...
const EyeshadowChangeColor = new DynamicStructuredTool({
    ...
    schema: z.object({
        color: z
            .string()
            .describe(
                "set eyeshadow color in R G B A format (separated with space). Each value should be in a range from 0 to 1 (including decimal)."
            ),
    }),
    func: async ({ color }) => {
        console.log("EyeshadowChangeColor with parameter called", color);
        broadcastMessage(
            JSON.stringify({ tool_name: "EyeshadowChangeColor", params: { color } })
        );
    },
});
...
const EyeLinerChangeColor = new DynamicStructuredTool({
    ...
    schema: z.object({
        color: z
            .string()
            .describe(
                "set eyeliner color in R G B A format (separated with space). Each value should be in a range from 0 to 1 (including decimal)."
            ),
    }),
    func: async ({ color }) => {
        console.log("EyeLinerChangeColor with parameter called", color);
        broadcastMessage(
            JSON.stringify({ tool_name: "EyeLinerChangeColor", params: { color } })
        );
    },
});
...
const HighlighterOn = new DynamicStructuredTool({
    ...
    func: async () => {
        ...
        broadcastMessage(
            JSON.stringify({ tool_name: "HighlighterOn", params: {} })
        );
    },
});
...
const HighlighterChangeColor = new DynamicStructuredTool({
    ...
    schema: z.object({
        color: z
            .string()
            .describe(
                "set highlighter color in R G B A format (separated with space). Each value should be in a range from 0 to 1 (including decimal)."
            ),
    }),
    func: async ({ color }) => {
        console.log("HighlighterChangeColor with parameter called", color);
        broadcastMessage(
            JSON.stringify({ tool_name: "HighlighterChangeColor", params: { color } })
        );
    },
});
...
const HighlighterOff = new DynamicStructuredTool({
    ...
    func: async () => {
        ...
        broadcastMessage(
            JSON.stringify({ tool_name: "HighlighterOff", params: {} })
        );
    },
});
...
const ContourChangeColor = new DynamicStructuredTool({
    ...
    schema: z.object({
        color: z
            .string()
            .describe(
                "set contour color in R G B A format (separated with space). Each value should be in a range from 0 to 1 (including decimal)."
            ),
    }),
    func: async ({ color }) => {
        console.log("ContourChangeColor with parameter called", color);
        broadcastMessage(
            JSON.stringify({ tool_name: "ContourChangeColor", params: { color } })
        );
    },
});
...
const FoundationChangeColor = new DynamicStructuredTool({
    ...
    schema: z.object({
        color: z
            .string()
            .describe(
                "set skin color in R G B A format (separated with space). Each value should be in a rage from 0 to 1 (including decimal)."
            ),
    }),
    func: async ({ color }) => {
        console.log("FoundationChangeColor with parameter called", color);
        broadcastMessage(
            JSON.stringify({ tool_name: "FoundationChangeColor", params: { color } })
        );
    },
});
...
const FoundationOff = new DynamicStructuredTool({
    ...
    func: async () => {
        ...
        broadcastMessage(
            JSON.stringify({ tool_name: "FoundationOff", params: {} })
        );
    },
});
...
const BlushChangeColor = new DynamicStructuredTool({
    ...
    schema: z.object({
        color: z
            .string()
            .describe(
                "set blush color in R G B A format (separated with space). Each value should be in a rage from 0 to 1 (including decimal)."
            ),
    }),
    func: async ({ color }) => {
        console.log("BlushChangeColor called");
        broadcastMessage(
            JSON.stringify({ tool_name: "BlushChangeColor", params: { color } })
        );
    },
});
